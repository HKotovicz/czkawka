...
core_failed_to_optimize_image = Failed to optimize image "{ $file }": { $reason }
...
core_failed_to_open_image = Failed to open image "{ $file }": { $reason }
core_failed_to_read_image = Failed to read image "{ $file }": { $reason }
core_unknown_image_format = Unknown image format for "{ $file }"
core_failed_to_decode_image = Failed to decode image "{ $file }": { $reason }
core_failed_to_create_output = Failed to create output file "{ $file }": { $reason }
core_failed_to_encode_image = Failed to encode image "{ $file }": { $reason }
core_failed_to_replace_original = Failed to replace original file "{ $file }": { $reason }
core_unsupported_image_format = Unsupported image format: "{ $format }"
